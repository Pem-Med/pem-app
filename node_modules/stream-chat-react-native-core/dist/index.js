...
var AutoCompleteInput = /*#__PURE__*/function (_React$PureComponent) {
  ...
  function AutoCompleteInput(props) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 4;
                return triggers[_this.state.currentTrigger].dataProvider(q, _this.state.text, function (data, query) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleSuggestions", function (text) {
      ...
      setTimeout(function () {
        var selectionEnd = _this.state.selectionEnd;
        if (text.slice(selectionEnd - 1, selectionEnd) === ' ' && !_this.state.isTrackingStarted) return;
...
var KeyboardCompatibleView = /*#__PURE__*/function (_React$PureComponent) {
  ...
  _createClass(KeyboardCompatibleView, [{
    ...
    value: function render() {
      ...
      if (!this.props.enabled) {
        return React__default.createElement(KeyboardContext.Provider, {
          value: this.getContext()
        }, this.props.children);
      }

      return React__default.createElement(reactNative.Animated.View, animatedViewProps, React__default.createElement(KeyboardContext.Provider, {
        value: this.getContext()
      }, React__default.createElement(reactNative.View, {
...
var MessageInput = /*#__PURE__*/function (_PureComponent) {
  ...
  function MessageInput(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "isValidMessage", function () {
      ...
      try {
        for (var _iterator3 = _this.state.imageOrder[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
          var id = _step3.value;
      ...
      try {
        for (var _iterator4 = _this.state.fileOrder[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    _defineProperty(_assertThisInitialized(_this), "sendMessage", function () {
      ...
      try {
        for (var _iterator5 = _this.state.imageOrder[Symbol.iterator](), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
          var id = _step5.value;
          var image = _this.state.imageUploads[id];
      ...
      try {
        for (var _iterator6 = _this.state.fileOrder[Symbol.iterator](), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
