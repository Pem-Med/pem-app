...
import {
  FlatList, Platform, Button, Alert, ActivityIndicator, View,
} from 'react-native'
...
const AdminSubCategoriesScreen = (props) => {
  ...
  const editSubCategoryHandler = (id, categoryId) => {
    props.navigation.navigate('EditCatContent', { subCatId: id, categoryId })
  }
  ...
  const createHandler = useCallback(() => {
    props.navigation.navigate('EditCatContent', { categoryId })
  }, [])
